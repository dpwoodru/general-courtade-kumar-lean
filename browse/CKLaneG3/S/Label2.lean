...
import CKLaneG3.S.C2.B0
import CKLaneG3.S.C2.B1
import CKLaneG3.S.C2.B2
import CKLaneG3.S.C2.B3
import CKLaneG3.S.C2.B4
import CKLaneG3.S.C2.B5
import CKLaneG3.S.C2.B6
import CKLaneG3.S.C2.B7
import CKLaneG3.S.C2.B8
import CKLaneG3.S.C2.B9
import CKLaneG3.S.C2.B10

/-! Lane G3b: (S) owner label 2 bound to the archived leaves of `sTree`, assembled from
83 per-chunk facts in 11 block modules (key M03s, mode slice; generated by
...
/-- The per-leaf predicate of owner label 2. -/
abbrev PP : List ℕ × ℕ → Prop := fun q => q.2 = 2 → SLeafOK (sBox q.1)
