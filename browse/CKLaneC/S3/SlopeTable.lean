...
/-!
# Lane C3 (snapshot copied into Lane C, namespace CKLaneC.S3) — a checked one-dimensional slope table for the E8 inverse jet
...
namespace CKLaneC.S3.SlopeTable
